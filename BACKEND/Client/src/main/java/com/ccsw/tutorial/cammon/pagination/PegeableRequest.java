package com.ccsw.tutorial.cammon.pagination;
...
public class PegeableRequest implements Serializable {
    ...
    public PegeableRequest() {

        sort = new ArrayList<>();
    }

    public PegeableRequest(int pageNumber, int pageSize) {
    ...
    public PegeableRequest(int pageNumber, int pageSize, List<SortRequest> sort) {
